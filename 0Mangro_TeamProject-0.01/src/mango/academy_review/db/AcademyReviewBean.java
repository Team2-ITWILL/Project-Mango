...
public class AcademyReviewBean {
 ...
 // 승인일자 
 private String reviewConfirmDate;
 ...
 public String getReviewConfirmDate() {
     return reviewConfirmDate;
 }

 public void setReviewConfirmDate(String reviewConfirmDate) {
     this.reviewConfirmDate = reviewConfirmDate;
 }
