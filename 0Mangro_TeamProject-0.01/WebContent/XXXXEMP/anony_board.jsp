...
<link rel="stylesheet" type="text/css" href="styles/anony_board_responsive.css">
</head>
<body>
		...
		<div class="container">
					...
					<div class="blog_post_container">
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="anony_board_single.jsp">Here’s What You Need to Know About Online Testing</a></div>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="blog_single.jsp">Here’s What You Need to Know About Online Testing</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="#">admin</a></li>
										<li><a href="#">november 11, 2017</a></li>
			...
			<div class="row">
				<div class="col text-center">
					<div class="load_more trans_200"><a href="#">더보기</a></div>
				</div>
			</div>
		</div>
	</div>
