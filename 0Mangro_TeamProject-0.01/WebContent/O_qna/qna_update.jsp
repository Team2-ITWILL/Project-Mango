...
<div class = "qna_container container">
	...
	<form name="fwrite" id="fwrite" action="./QnaBoardUpdateAction.qna?pageNum=${pageNum}" method="post" autocomplete="off" style="width:100%">
		
		
		<input type="hidden" name="qna_board_num" value="${qbean.qna_board_num}">
	 	...
	 	<div class="bo_w_info write_div">
	        ...
	        <input type="text" name="mem_email" id="wr_name" class="frm_input required"
	        value = "${qbean.mem_email}">
	    	...
	    	<c:choose>
		    	<c:when test="${id_email eq 'admin' || id_email eq 'admin@mango.com'}">
			    	...
			    	<c:if test="${qbean.qna_notice eq '1'}">
			    	
				    	<div class = "frm_input required">
					    	<input type = "radio" name = "qna_notice" value = "0"checked="checked" style="font-family: 'Noto Sans KR', 'sans-serif'" >  일반글   
							<input type = "radio" name = "qna_notice" value = "1" checked="checked" style="font-family: 'Noto Sans KR', 'sans-serif'">  공지사항으로 설정
				    	</div>
	    ...
	    <div class="bo_w_tit write_div">
	    	...
	    	<div id="autosave_wrapper write_div">
	            <input type="text" name = "qna_board_title" id="wr_subject"  class="frm_input full_input required" size="50" maxlength="255" 
	            value = "${qbean.qna_board_title}">
	       	</div>
	    </div>
	    ...
	    <div class="write_div">
	        ...
	        <div class="wr_content ">
			   ...
			   <textarea id = "wr_content" name = "qna_board_content" style="width:100%;">
			   		${qbean.qna_board_content}
			   </textarea>
