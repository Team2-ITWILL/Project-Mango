...
<div class = "qna_container container">
	...
	<form name="fwrite" id="fwrite" action="./QnaBoardWriteAction.qna" enctype="multipart/form-data" autocomplete="off" style="width:100%">
	 	...
	 	<div class="bo_w_info write_div">
	    	...
	    	<c:if test="${id_email eq 'admin' || id_email eq 'admin@mango.com'}">
	    ...
	    <div class="bo_w_tit write_div">
	    	...
	    	<div id="autosave_wrapper write_div">
	            <input type="text" name="qna_board_title" value="" id="wr_subject" class="frm_input full_input required" size="50" maxlength="255" placeholder="제목">
	       	</div>
	    </div>
